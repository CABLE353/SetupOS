...
-----------------------------------------Tools you need----------------------------------------------
	...
	Chargers for each type of Windows machine.

	The ability to have a network share folder(Offline share of course).
...
Thanks for getting through all of that, if you have any questions just message me on Teams at "Caleb Eagar" or "ceagar" and I will get to you when I get time away from my TSM Missionary assignment here at the ROB.
